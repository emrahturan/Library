...
using MyLibrary.Core.CrossCuttingConcerns.Caching;

namespace MyLibrary.Core.Aspects.PostSharp.CacheAspects
{
    [Serializable]
    public class CacheAspect : MethodInterceptionAspect
    {
        ...
        public override void OnInvoke(MethodInterceptionArgs args)
        {
            ...
            var key = string.Format("{0}({1})", methodName, arguments.Select(x => x != null ? x.ToString() : "<Null>"));
